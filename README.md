...
[![Coverage Status](https://coveralls.io/repos/pyopenapi/pyopenapi/badge.svg?branch=master&style=flat)](https://coveralls.io/r/mission-liao/pyopenapi?branch=master)
...
**pyopenapi** is much easier to use (compared to swagger-codegen, you don't need to prepare a scala environment) and tries hard to **fully supports** [Swagger Spec](https://helloreverb.com/developers/swagger) in all aspects.
...
report an issue:
- issues can be reported [here](https://github.com/mission-liao/pyopenapi/issues)
...
- What do we need to take care of when upgrading from Swagger 1.2 to 2.0?
  ...
  - The name of body parameters is no longer included in requests, refer to this [issue](https://github.com/mission-liao/pyopenapi/issues/13) for details.
